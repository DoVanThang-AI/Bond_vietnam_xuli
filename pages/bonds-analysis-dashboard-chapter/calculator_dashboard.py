...
layout = dbc.Row([
            ...
            dbc.Col([],
                id="content-area", className='col-8 p-4',style={'background-color':'whitesmoke','border-radius':'25px'})
    
], style={'height':'100vh', 'overflow':'scroll'}, className='m-2 justify-content-center '),
